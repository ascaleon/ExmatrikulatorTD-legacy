alter table Auras_Buffs drop constraint FK2dhd0yqlwuflio8qsrk1g7ds4
alter table Auras_Buffs drop constraint FKdnyywnjna40n8uutrmj93obhk
alter table Auras_Debuffs drop constraint FKlu2wbhjrw899ognst18eniftb
alter table Auras_Debuffs drop constraint FK1wlylay7nw9335e6aftg2s8kq
alter table collision_matrix drop constraint FKi91vt62lgb35fd4x0ahq03wwy
alter table collision_matrix drop constraint FKajn6nmi3qk77a7dtn9p4ev15p
alter table Enemies_Debuffs drop constraint FKd78mtlqmn00d1fpscfhxlaq5r
alter table Enemies_Debuffs drop constraint FKox152unif9g3judfxvymcxuad
alter table Gamestate_Enemies drop constraint FKei20x6cnmab9wr1ey2lhnuwh5
alter table Gamestate_Enemies drop constraint FKihjulv9o9a1f050dbwkfvn3iy
alter table Gamestate_Players drop constraint FK1ij8retuer729ui39qaf1mh6e
alter table Gamestate_Players drop constraint FKhx49kewejkq0jksvpg0yleacb
alter table Gamestate_Projectiles drop constraint FKsr0f0qje5avtd4m1lfd9fyhwl
alter table Gamestate_Projectiles drop constraint FKcgsjbfhy6ysg8i222dgsuv6ys
alter table Gamestate_Towers drop constraint FKnsrundee2nmq25ps38t7ltoly
alter table Gamestate_Towers drop constraint FKciebtgakjoj90dfm0odiasscr
alter table Gamestate_waypoints drop constraint FKmo8euhktm6ftmp40akusppnmk
alter table Gamestate_waypoints drop constraint FKse6oa93q6b0k650runj5479xb
alter table Highscores drop constraint FKg1u82fa9144lv78wj2eawb53v
alter table Players_Waves drop constraint FKeqgnb8jrfmehlnjsshma01lc
alter table Players_Waves drop constraint FK1vmaa817r73i92te8bdt7pn8b
alter table Players_waypoints drop constraint FKnbriyka2be8cnyl6m45s0gpyx
alter table Players_waypoints drop constraint FK7y00hmwnsh3uc2x0niflqhmoo
alter table Projectiles drop constraint FKm2npdnu7kklpu5q687qkqe2jv
alter table Projectiles_Debuffs drop constraint FKa4m5vwje8uook34u0b7dw4gg2
alter table Projectiles_Debuffs drop constraint FK9xa7voiw6o93pv9i67tew8auw
alter table SaveState drop constraint FKp89i8qyc4vsn0wl6ew6ndubvx
alter table SaveState drop constraint FK2vjbl51tnq7ufh776xqt2iuj4
alter table Towers drop constraint FK1tp9iivew89809wmljvy52kh5
alter table Towers_Auras drop constraint FKbfuroltderboqhmvils4d5npw
alter table Towers_Auras drop constraint FKdtgojl4myvpx18y5nxfq48p4v
alter table Towers_Buffs drop constraint FK5ugato2n1nbk3m2k9wyod2kh6
alter table Towers_Buffs drop constraint FKmax38146id3h52j2q1osayyig
alter table Towers_Debuffs drop constraint FK1q214g6s2eg0sgc6mk2tid12d
alter table Towers_Debuffs drop constraint FKj7l8vgv3x5p4kwuydij7puidv
alter table Waves_Enemies drop constraint FKg730sjfdybwj1qdht8aqhohjx
alter table Waves_Enemies drop constraint FK3xvg4p9r1j0oocwydnglmkp8j
drop table Auras
drop table Auras_Buffs
drop table Auras_Debuffs
drop table Buffs
drop table collision_matrix
drop table Debuffs
drop table Enemies
drop table Enemies_Debuffs
drop table Gamestate
drop table Gamestate_Enemies
drop table Gamestate_Players
drop table Gamestate_Projectiles
drop table Gamestate_Towers
drop table Gamestate_waypoints
drop table Highscores
drop table Players
drop table Players_Waves
drop table Players_waypoints
drop table Profiles
drop table Projectiles
drop table Projectiles_Debuffs
drop table SaveState
drop table Towers
drop table Towers_Auras
drop table Towers_Buffs
drop table Towers_Debuffs
drop table Waves
drop table Waves_Enemies
