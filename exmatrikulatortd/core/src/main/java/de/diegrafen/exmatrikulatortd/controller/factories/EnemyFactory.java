...
public final class EnemyFactory {
    ...
    private static Enemy createRegularEnemy() {
        return new Enemy("Regular Enemy", 200, 100, 1, 50, 50, MEDIUM, 2, REGULAR_ENEMY_ASSETS, 0, 0, 10);
    }
    ...
    private static Enemy createHeavyEnemy() {
        return new Enemy("Heavy Enemy", 175, 150, 2, 100, 100, HEAVY, 5, HEAVY_ENEMY_ASSETS, 0, 0, 20);
    }
