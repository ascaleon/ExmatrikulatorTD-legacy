...
public class DistanceComparator implements Comparator<ObservableUnit> {
     ...
     */
    @Override
    public int compare(ObservableUnit o1, ObservableUnit o2) {

        int returnValue = 0;
        double distanceO1 = Point2D.distance(xPosition, yPosition, o1.getxPosition(), o1.getyPosition());
        double distanceO2 = Point2D.distance(xPosition, yPosition, o2.getxPosition(), o2.getyPosition());
